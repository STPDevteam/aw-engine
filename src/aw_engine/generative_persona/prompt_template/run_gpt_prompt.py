...
def run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False):
    ...
    def create_prompt_input(persona, test_input=None):
        ...
        prompt_input = [
            persona.get_str_iss(),
            persona.get_str_lifestyle(),
            persona.get_str_firstname(),
        ]
        return prompt_input
...
def run_gpt_prompt_daily_plan(persona, wake_up_hour, test_input=None, verbose=False):
    ...
    def create_prompt_input(persona, wake_up_hour, test_input=None):
        if test_input:
            return test_input
        prompt_input = []
        prompt_input += [persona.get_str_iss()]
        prompt_input += [persona.get_str_lifestyle()]
        prompt_input += [persona.get_str_curr_date_str()]
        prompt_input += [persona.get_str_firstname()]
